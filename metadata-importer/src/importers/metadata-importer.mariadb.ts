...
import mariaDbDataTypeMapping = require('../../metadata-mapping/mariadb.json');
var mysql = require('mysql2/promise');



export class MariaDbMetadataImporter extends AbstractMetadataImporter {
    protected async importObjectInternal(modelId, objects: any[], userId,
        ...
        let connection = await mysql.createConnection({
            ...
            for (const columnRow of columnsRows) {
                ...
                let usage = mariaDbDataTypeMapping[columnRow.data_type].usage;
                ...
                entry.modelObjectItems.push({
                    ...
                    usage,
                    usageType: mariaDbDataTypeMapping[columnRow.data_type].usageType,
                    defaultAggregation: mariaDbDataTypeMapping[columnRow.data_type].defaultAggregation,
