...
import { PostgresQueryGeneratorImpl } from '../../generators/postgres-generator';
...
describe('Test postgres query generator',  () => {
    ...
    beforeEach(() => {
        ...
        queryGenerator = new PostgresQueryGeneratorImpl(generatorState);
    ...
    it('test getDbName', ()=> {
        expect(queryGenerator.getDbName()).toEqual('Postgres');
    });
});