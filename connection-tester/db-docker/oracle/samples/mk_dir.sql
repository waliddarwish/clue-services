...
CREATE OR REPLACE DIRECTORY data_file_dir AS '/u01/samples/sales_history/'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS '/u01/samples/log/'; 
CREATE OR REPLACE DIRECTORY media_dir     AS '/u01/samples/product_media/';
