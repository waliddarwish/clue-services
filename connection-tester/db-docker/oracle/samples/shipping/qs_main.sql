...
REM will succeed even if the users and temp tablespaces do
REM not exist.
REM =======================================================
...
CREATE USER qs_adm IDENTIFIED BY Oradoc_db1;
ALTER USER qs_adm DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
ALTER USER qs_adm TEMPORARY TABLESPACE temp;

REM ALTER USER qs_adm DEFAULT TABLESPACE users QUOTA ON users UNLIMITED;
REM ALTER USER qs_adm TEMPORARY TABLESPACE temp;
...
CREATE USER qs IDENTIFIED BY Oradoc_db1;
ALTER USER qs DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_ws IDENTIFIED BY Oradoc_db1;
ALTER USER qs_ws DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_es IDENTIFIED BY Oradoc_db1;
ALTER USER qs_es DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_os IDENTIFIED BY Oradoc_db1;
ALTER USER qs_os DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_cbadm IDENTIFIED BY Oradoc_db1;
ALTER USER qs_cbadm DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_cb IDENTIFIED BY Oradoc_db1;
ALTER USER qs_cb DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
...
CREATE USER qs_cs IDENTIFIED BY Oradoc_db1;
...
CONNECT qs_adm/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_adm

PROMPT calling qs_cre.sql ...
CONNECT qs/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_cre

PROMPT calling qs_es.sql ...
CONNECT qs_es/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_es

PROMPT calling qs_ws.sql ...
CONNECT qs_ws/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_ws

PROMPT calling qs_os.sql ...
CONNECT qs_os/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_os

PROMPT calling qs_cbadm.sql ...
CONNECT qs_cbadm/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_cbadm

PROMPT calling qs_cs.sql ...
CONNECT qs_cs/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_cs

PROMPT calling qs_run.sql ...
CONNECT qs_adm/Oradoc_db1@SAMPLES
@/u01/samples/shipping/qs_run
