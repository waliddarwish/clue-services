...
DEFINE spool_file = &log_path.ix_v3..log
SPOOL &spool_file 
...
ALTER USER ix DEFAULT TABLESPACE users QUOTA UNLIMITED ON users;
ALTER USER ix TEMPORARY TABLESPACE temp;
...
CONNECT ix/Oradoc_db1@SAMPLES

DEFINE vscript = /u01/samples/info_exchange/cix_v3
@&vscript
...
DEFINE vscript = /u01/samples/info_exchange/vix_v3
@&vscript
