...
DEFINE data_path = /u01/samples/sales_history/
PROMPT
...
DEFINE ctl_file = &data_path.time_v3.ctl
DEFINE dat_file = &data_path.time_v3.dat
DEFINE log_file = &log_path.time_v3.log
...
HOST sqlldr sh/Oradoc_db1@SAMPLES  -
...
DEFINE ctl_file = &data_path.coun_v3.ctl
DEFINE dat_file = &data_path.coun_v3.dat
DEFINE log_file = &log_path.coun_v3.log
...
DEFINE ctl_file = &data_path.cust_v3.ctl
DEFINE dat_file = &data_path.cust1v3.dat
DEFINE log_file = &log_path.cust1v3.log
...
DEFINE ctl_file = &data_path.prod_v3.ctl
DEFINE dat_file = &data_path.prod1v3.dat
DEFINE log_file = &log_path.prod1v3.log
...
DEFINE ctl_file = &data_path.prom_v3.ctl
DEFINE dat_file = &data_path.prom1v3.dat
DEFINE log_file = &log_path.prom1v3.log
...
DEFINE ctl_file = &data_path.chan_v3.ctl
DEFINE dat_file = &data_path.chan_v3.dat
DEFINE log_file = &log_path.chan_v3.log
...
DEFINE ctl_file = &data_path.sale_v3.ctl
DEFINE dat_file = &data_path.sale1v3.dat
DEFINE log_file = &log_path.sale1v3.log
...
DEFINE ctl_file = &data_path.dmsal_v3.ctl
DEFINE dat_file = &data_path.dmsal_v3.dat
DEFINE log_file = &log_path.dmsal_v3.log
...
DEFINE ctl_file = &data_path.dem_v3.ctl
DEFINE dat_file = &data_path.dem1v3.dat
DEFINE log_file = &log_path.dem1v3.log
