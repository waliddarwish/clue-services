...
DEFINE pm_dat_path    = /u01/samples/product_media/
DEFINE pm_log_path    = /u01/log
DEFINE pm_wrk_path    = /u01/samples/product_media/

DEFINE ctl_file = &pm_dat_path.pm_p_lob.ctl
DEFINE dat_file = &pm_wrk_path.pm_p_lob.dat
DEFINE log_file = &pm_log_path.pm_p_lob.log

HOST sqlldr pm/Oradoc_db1@SAMPLES control=&ctl_file data=&dat_file log=&log_file
