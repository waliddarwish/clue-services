...
DEFINE pass_sys = Oradoc_db1
PROMPT
PROMPT specify directory path for the PM data files as parameter 6:
DEFINE data_path = /u01/samples/product_media/
PROMPT
...
ALTER USER pm DEFAULT TABLESPACE users QUOTA UNLIMITED ON users; 
...
@/u01/samples/product_media/pm_cre.sql   -- create objects

REM =======================================================
REM use sqlldr to populate PRINT_MEDIA and its nested table
REM =======================================================
 
@/u01/samples/product_media/pm_p_lob 

REM =======================================================
REM finish
REM =======================================================

@/u01/samples/product_media/pm_analz -- gather statistics 
